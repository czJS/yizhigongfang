...
- In installed app, YGF_APP_ROOT points to the Electron resources directory, where:
    - pipelines/quality_pipeline.py exists on disk
...
from core.runtime_paths import detect_repo_root, pick_pipelines_dir
...
def _prepare_env(root: Path) -> None:
    ...
    # Ensure repo root is importable for `from pipelines import ...` and `from backend import ...`
